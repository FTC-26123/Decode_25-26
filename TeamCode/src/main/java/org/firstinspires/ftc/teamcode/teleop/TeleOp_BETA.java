...
//        Rotation
        ...
        telemetry.addLine("Launcher Velocity: " + launcher.getVelocity() + " ... Launcher RPM: " + decimalFormat.format(launcher.getVelocity() / 28 * 60) + "RPM");
        ...
        if (shooterIsBusy) { // checking for stall motor
            if (launcher.getCurrent(CurrentUnit.AMPS) > motorStallThreshold) {
                telemetry.addLine("Launcher Stalled!");
